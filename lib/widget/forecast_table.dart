              ...
              TableCell(
                child: Padding(
                  ...
                  child: ColorTransitionText(
                    text: dt.DateUtils.weekdays[dailyWeather.dateTime.weekday],
                    style: textStyle,
...
// we have a table that has 7 rows and in each row there are 4 cells writing this code by yourself will be tadious so it is always preferable to generate the contenet of large table programmatically using methods like list.generate
